...
import { addToCart } from '../context/appReducer';
...
const ProductDetails = () => {
    ...
    const {products,currency} = useSelector(({store})=> store);
    const {id} = useParams();
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center mt-10 gap-4 text-base">
                        <button onClick={()=> {
                            ...
                            toast.success("Added to Cart")}} className="w-full py-3.5 cursor-pointer font-medium bg-gray-100 text-gray-800/80 hover:bg-gray-200 transition" >
                            Add to Cart
                        </button>
                        <button onClick={()=> {
                            dispatch(addToCart({itemId: product._id}));
